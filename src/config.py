...
PREFERRED_CATEGORIES = [
    ...
    if c.strip()
]  # e.g. "POLITICS,ECONOMICS,SCIENCE" — fetches top leaders per category
LEADERS_PER_CATEGORY = _int("LEADERS_PER_CATEGORY", 10)  # fetch top N per category
...
LIQUIDITY_GUARD = _bool(os.getenv("LIQUIDITY_GUARD", "true"))
SPREAD_GUARD = _bool(os.getenv("SPREAD_GUARD", "true"))
PRICE_BOUNDS_GUARD = _bool(os.getenv("PRICE_BOUNDS_GUARD", "true"))
BOOK_DEPTH_GUARD = _bool(os.getenv("BOOK_DEPTH_GUARD", "true"))
OVERLAP_GUARD = _bool(os.getenv("OVERLAP_GUARD", "true"))
